...
def plot_histogram(tsv_file1,tsv_file2,fig_file):
...
plot_histogram("raw_reacts/denatured_rawreactsAC.tsv","raw_reacts/denatured_rawreactsGT.tsv","raw_reacts/rawreacts_denatured.pdf")
